#codeigniter-login-logout register craete groups and all group assign modeuls 
start for Codeigniter 3 with hmvc extension add othing extra third party downloaded all featured add here
